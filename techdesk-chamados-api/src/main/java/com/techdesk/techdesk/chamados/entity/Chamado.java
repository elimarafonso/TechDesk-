 ...
 //   private Tecnico tecnico;
  ...
  //  @JoinColumn(name = "usuario_id", nullable = false)
   // private Usuario usuario;
    ...
    public Chamado(Long id, String titulo, String descricao, StatusChamado statusChamado, LocalDateTime dataAbertura, LocalDateTime dataFechamento, Categoria categoria, Tecnico tecnico, Usuario usuario) {
        this.id = id;
        this.titulo = titulo;
